                 ...
                 <div class="col-lg-3 col-md-6">
                     <div class="footer_about mt-50">
                         <div class="footer_logo">
                             <a href="#"><img src="{{ asset('assets/images/logo-white.png') }}" alt="logo" width="250px"></a>
                         </div>
                         <div class="footer_content">
                             <p>Lorem ipsum dolor sitco nsetetu nonumy eirmod tempor invidunt ut labore et dolore magna
                                 uyam erat, sed diam.</p>
                         </div>
                     </div> <!-- footer about -->
                 </div>
